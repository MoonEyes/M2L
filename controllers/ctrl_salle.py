...
def afficherLesSalles():
    ...
    """
    rowsSalles =db(db.salle.categorie_id==db.categorie.id).select(db.salle.id,db.salle.nom,db.salle.capacite,db.categorie.nom,db.categorie.heureOuverture,db.categorie.heureOuvertureMinutes) #requête permettant de récupérer les informations des salles
